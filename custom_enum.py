...
if __name__ == "__main__":
    ...
    print(CELightColor.possible_values)
    print(CELightColor.reversed_dict)

    print(CELightColor(CELightColor.green) == CELightColor.green)
    print(CELightColor(CELightColor.green) == "green")
    print(CELightColor(CELightColor.green) == CELightColor(CELightColor.green))
