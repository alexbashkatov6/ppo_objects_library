...
class PpoPoint(PpoObject):
    ...
    section = AnyDescriptor()
    railFittersWarningArea = AnyDescriptor()
    autoReturn = AnyDescriptor(is_required=False)
    guardPlusPlus = AnyDescriptor(is_list=True)
    guardPlusMinus = AnyDescriptor(is_list=True)
    guardMinusPlus = AnyDescriptor(is_list=True)
    guardMinusMinus = AnyDescriptor(is_list=True)
    lockingPlus = AnyDescriptor(is_list=True)
    lockingMinus = AnyDescriptor(is_list=True)
    additionalSwitch = AnyDescriptor(internal_obj_type="AdditionalSwitch", is_list=True)
    pairPoint = AnyDescriptor()
    oversizedPlus = AnyDescriptor(internal_obj_type="SectionAndIgnoreCondition", is_list=True)
    oversizedMinus = AnyDescriptor(internal_obj_type="SectionAndIgnoreCondition", is_list=True)
    additionalGuardLock = AnyDescriptor(internal_obj_type="SectionAndIgnoreCondition", is_list=True)
